---
title: "R Series Episode 1: <br/>Making Your Research Reproducible <br/>with Quarto in RStudio"
subtitle: ""
...
-   It is highly *extensible* and it has thousands of well-documented extensions (named R packages) for a very broad range of applications areas such as finance, business, economic, biostatistics and etc (As of January 2026 \~20000 R packages).

-   It has a vast community both in academia and in business such as [stack overflow](https://stackoverflow.com/) and [Posit Community](https://community.rstudio.com/) (formally known as RStudio Community).

------------------------------------------------------------------------

### [The CRAN Task View](https://www.maths.lancs.ac.uk/~rowlings/R/TaskViews/)

![](img01/image7.jpg){fig-align="center"}
...
![](img01/image3a.jpg){fig-align="center"}
...
![](img01/image3b.jpg){width="800"}

## Introducing [R Studio](https://posit.co/products/open-source/rstudio/)

-   A free and open-source integrated development environment (IDE) for R.

![](img01/image3.jpg)

## Introducing Quarto![](img01/image4a.jpg){fig-align="center" width="200"}

-   [Quarto](https://quarto.org/) is an open-source scientific and technical publishing system designed and developed by [posit](https://posit.co/) formally known as RStudio.

![](img01/image4.jpg){fig-align="center" width="900"}
...
-   A method of [*literate programming*](https://en.wikipedia.org/wiki/Literate_programming) that embed code and output from Python, R, and JavaScript via integration with [Jupyter](https://jupyter.org/), [Julia](https://quarto.org/docs/computations/julia.html), and [Observable](https://quarto.org/docs/computations/ojs.html).

    ![](img01/image5.jpg){width="800"}
...
[28 Quarto](https://r4ds.hadley.nz/quarto.html) of [R for Data Science (2e)](https://r4ds.hadley.nz/)

Quarto [Guide](https://quarto.org/docs/guide/)

[Quarto examples gallery](https://quarto.org/docs/gallery/)
...
[Get started with Quarto](https://www.youtube.com/watch?v=_f3latmOhew) by Mine Çetinkaya-Rundel

[Quarto for Academics](https://www.youtube.com/watch?v=EbAAmrB0luA) by Mine Çetinkaya-Rundel

```{r}
#| eval: false
#| echo: false
renderthis::to_pdf(from ="R_series_Episode01-Intro_to_Quarto.qmd")
```
